                                   ...
                                   outdir = "output_analysis")
{
  ...
  message("Normalization through SCtransform v2, with regression to rRNA...")
  seurat_obj = SCTransform(seurat_obj, verbose = FALSE, vst.flavor="v2", vars.to.regress = "percent.rRNA")
  
  saveRDS(seurat_obj, paste0(outdir,"/" ,seurat_obj@project.name, "_qc_sctransform_regressout_rrna.RDS"))
